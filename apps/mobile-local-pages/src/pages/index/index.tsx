  ...
  return (
    <div className='w-[100vw]'>
      ...
      <div className="py-[2em]">
        <button className='!bg-brand-default text-neutral-title-2' onClick={() => setCount((count) => count + 1)}>
          count is {count}
        </button>
        <p className='text-neutral-title-1 mt-[16px] gap-[12px] flex flex-row w-full justify-center'>
          <span className='rounded-[4px] inline-block border-[1px] border-neutral-line py-[4px] px-[6px]'>themeMode: {themeMode}</span>
          <span className='rounded-[4px] inline-block border-[1px] border-neutral-line py-[4px] px-[6px]'>platform: {getInjectedObject().platform}</span>
        </p>
      </div>
