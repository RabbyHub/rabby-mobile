...
export BUNDLE_FORCE_RUBY_PLATFORM="${BUNDLE_FORCE_RUBY_PLATFORM:-false}"
export RABBY_MOBILE_TURBO_BUNDLE_PATH="${RABBY_MOBILE_TURBO_BUNDLE_PATH:-$BUNDLE_PATH}"
export RABBY_MOBILE_TURBO_BUNDLE_APP_CONFIG="${RABBY_MOBILE_TURBO_BUNDLE_APP_CONFIG:-$mobile_dir/.bundle}"
export RABBY_MOBILE_TURBO_BUNDLE_FORCE_RUBY_PLATFORM="${RABBY_MOBILE_TURBO_BUNDLE_FORCE_RUBY_PLATFORM:-false}"
mkdir -p "$BUNDLE_PATH"
