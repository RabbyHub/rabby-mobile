      ...
      [
        'module-resolver',
        {
          ...
          alias: {
            ...
            '^@/devtools/perpsProPagerProbe/runtime$': `./src/devtools/perpsProPagerProbe/runtime.${regressionScenarioImplExt}`,
            '^@/devtools/perpsProPagerProbe/react$': `./src/devtools/perpsProPagerProbe/react.${regressionScenarioImplExt}`,
            '^@/devtools/perpsProPagerProbe/coordinator$': `./src/devtools/perpsProPagerProbe/coordinator.${regressionScenarioImplExt}`,
