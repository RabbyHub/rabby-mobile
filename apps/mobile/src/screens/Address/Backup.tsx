...
function Backup(): JSX.Element {
  ...
  const backupSeedPhraseRef = React.useRef('');
  ...
  const handleSetPasswordAndUpload = React.useCallback(
    async (newPassword: string) => {
      ...
      try {
        ...
        await handleUpload(newPassword, backupSeedPhraseRef.current);
      } catch {
  ...
  const handleCloudBackupWithAutoGenPassword = React.useCallback(async () => {
    ...
    seedPhraseData = await apiMnemonic.getMnemonics(autoGenPassword, address);
    autoGenPasswordForBackupRef.current = autoGenPassword;
    backupSeedPhraseRef.current = seedPhraseData;
