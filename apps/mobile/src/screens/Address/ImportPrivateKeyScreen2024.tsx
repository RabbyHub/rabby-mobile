  ...
  return (
    <FooterButtonScreenContainer
      ...
      buttonProps={{
        ...
        testID: E2E_ID.onboarding.privateKeySubmit,
        accessibilityLabel: E2E_ID.onboarding.privateKeySubmit,
      }}
      style={styles.screen}
            ...
            <View>
              <NextInput.TextArea
                ...
                inputProps={{
                  ...
                  blurOnSubmit: true,
                  returnKeyType: 'done',
                  testID: E2E_ID.onboarding.privateKeyInput,
                  accessibilityLabel: E2E_ID.onboarding.privateKeyInput,
