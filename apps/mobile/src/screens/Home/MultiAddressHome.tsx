...
import RcIconPolymarket from '@/assets2024/icons/home/IconPolymarket.svg';
  ...
  const MENU_ARR = useMemo(
    () =>
      [
        ...
        {
          key: MultiHomeFeatTitle.Polymarket,
          title: 'Polymarket',
          icon: RcIconPolymarket,
        },
        {
    ...
    (key: MultiHomeFeatTitle) => {
      switch (key) {
        ...
        case MultiHomeFeatTitle.Perps:
          ...
          break;
        case MultiHomeFeatTitle.Polymarket:
          navigation.push(RootNames.StackTransaction, {
            screen: RootNames.Polymarket,
            params: {},
          });
          break;
        default:
