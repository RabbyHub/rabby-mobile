const PERPS_PRO_HORIZONTAL_PADDING = 32;
const PERPS_PRO_DESIGN_CONTENT_WIDTH = 361;
const PERPS_PRO_DESIGN_ORDER_BOOK_WIDTH = 136;
const PERPS_PRO_DESIGN_COLUMN_GAP = 14;
const PERPS_PRO_MIN_ORDER_BOOK_WIDTH = 112;

export const PERPS_PRO_MAIN_COLUMN_HEIGHT = 416;
export const PERPS_PRO_TRADE_AMOUNT_FIELD_HEIGHT = 42;

const PERPS_PRO_BOTTOM_SHEET_HANDLE_HEIGHT = 40;
const PERPS_PRO_PRECISION_CONTENT_TOP = 8 + 24 + 24;
const PERPS_PRO_PRECISION_OPTION_HEIGHT = 52;
const PERPS_PRO_PRECISION_OPTION_GAP = 8;
const PERPS_PRO_SHEET_MIN_BOTTOM_PADDING = 36;
const PERPS_PRO_PRECISION_MIN_HEIGHT = 150;
const PERPS_PRO_PRECISION_MAX_HEIGHT = 484;
