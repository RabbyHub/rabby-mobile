    ...
    <View style={[styles.navControls]}>
      <TouchableOpacity
        style={[
          ...
          !webviewState?.canGoBack && styles.disabledStyle,
        ]}
        onPress={event => onPressButtonInternal({ type: 'back', event })}>
        <RcBackCC color={colors2024['neutral-body']} />
      </TouchableOpacity>
      <TouchableOpacity
        style={[
          styles.navControlItem,
        ...
        <RcForwardCC color={colors2024['neutral-body']} />
      </TouchableOpacity>
      <TouchableOpacity
        style={[styles.navControlItem]}
        onPress={event => onPressButtonInternal({ type: 'reload', event })}>
        <RcRefreshCC color={colors2024['neutral-body']} />
      </TouchableOpacity>
      <TouchableOpacity
        onPress={() => {
      ...
      <View style={[styles.navControlItem]}>
        <DropdownMenuView menuConfig={menuConfigs}>
          <RcMoreCC color={colors2024['neutral-body']} />
        </DropdownMenuView>
      </View>
    </View>
  );
