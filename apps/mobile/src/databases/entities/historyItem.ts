...
export class HistoryItemEntity extends EntityAddressAssetBase {
  ...
  "is_small_tx" = EXCLUDED."is_small_tx",
  ...
  "history_custom_type" = EXCLUDED."history_custom_type"
  `;
