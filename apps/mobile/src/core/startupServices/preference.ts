...
export interface PreferenceStore {
  ...
  ledgerDmkClearSigningEnabledV2: boolean;
...
> {
  ...
  constructor(options: PreferenceServiceOptions) {
    ...
    super(
      APP_STORE_NAMES.preference,
      {
        ...
        ledgerDmkClearSigningEnabledV2: false,
  ...
  getLedgerDmkClearSigningEnabled = () => {
    return this.store.ledgerDmkClearSigningEnabledV2 === true;
  };

  setLedgerDmkClearSigningEnabled = (value: boolean) => {
    this.store.ledgerDmkClearSigningEnabledV2 = value;
  };
