...
// This file is the central wrapper for Text components with defaultProps applied.
// It imports from restricted packages and re-exports wrapped versions.
...
export const RNGHText = withDefaults(RNGHTextImpl, {
