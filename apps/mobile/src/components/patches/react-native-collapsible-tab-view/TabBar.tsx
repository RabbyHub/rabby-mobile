// @see file:///./../../../../node_modules/react-native-collapsible-tab-view/src/MaterialTabBar/TabBar.tsx
...
import { MaterialTabItem } from 'react-native-collapsible-tab-view/src/MaterialTabBar/TabItem';
import {
  MaterialTabBarProps,
  ItemLayout,
} from 'react-native-collapsible-tab-view/src/MaterialTabBar/types';
import { PatchedTabItem, PatchedTabItemProps } from './TabItem';

export type PatchedMaterialTabBarProps<T extends TabName = string> = Omit<
  MaterialTabBarProps<T>,
  'TabItemComponent'
> & {
  TabItemComponent?: (props: PatchedTabItemProps<T>) => React.ReactElement;
};
 ...
 * ```
 */
const PatchedMaterialTabBar = <T extends TabName = TabName>({
  tabNames,
  indexDecimal,
  scrollEnabled = false,
  indicatorStyle,
  index,
  TabItemComponent = PatchedTabItem,
...
}: PatchedMaterialTabBarProps<T>): React.ReactElement => {
...
const MemoizedTabBar = React.memo(PatchedMaterialTabBar);

export { MemoizedTabBar as PatchedMaterialTabBar };
