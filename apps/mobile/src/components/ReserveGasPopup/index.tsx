...
const ReserveGasContent = forwardRef<ReserveGasType, ReserveGasContentProps>(
  (props, ref) => {
    const {
      gasList,
      chain,
      ...
      <View style={styles.flex1}>
        <View style={{ paddingHorizontal: 16 }}>
          <Text style={styles.title}>
            {t('component.ReserveGasPopup.title')}
          </Text>
...
const SendReserveGasPopup = (
  ...
  const reverseGasContentRef = useRef<ReserveGasType>(null);
...
export { ReserveGasPopup, SendReserveGasPopup };
