...
@implementation RNRabbyKeychainV10Manager

@synthesize bridge = _bridge;
RCT_EXPORT_MODULE(RNRabbyKeychainV10Manager);
...
{
  return dispatch_queue_create("com.rabbywallet.KeychainV10Queue", DISPATCH_QUEUE_SERIAL);
}
