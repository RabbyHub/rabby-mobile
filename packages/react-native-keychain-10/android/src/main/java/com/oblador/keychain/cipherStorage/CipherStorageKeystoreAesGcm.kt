...
import com.rabbywallet.keychain10.resultHandler.CryptoContext
import com.rabbywallet.keychain10.resultHandler.CryptoOperation
...
class CipherStorageKeystoreAesGcm(
    ...
    private var androidKeychainAuthConfig = AndroidKeychainAuthConfig.biometricStrong()
    ...
    override fun setAndroidKeychainAuthConfig(config: AndroidKeychainAuthConfig) {
        androidKeychainAuthConfig = config
    }
    ...
    override fun decryptWithPromptPolicy(
        ...
        try {
            ...
            if (allowAuthenticatedSessionReuse || !requiresAuth) {
        ...
        if (requiresAuth) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                keyGenParameterSpecBuilder.setUserAuthenticationParameters(
                    validityDuration,
                    androidKeychainAuthConfig.keyAuthenticators
