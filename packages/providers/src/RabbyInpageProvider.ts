...
export type RabbyInpageProviderOptions = {
  /**
...
/**
 * The name of the stream consumed by {@link RabbyInpageProvider}.
 */
export const RabbyInpageProviderStreamName = 'rabby-provider';

export class RabbyInpageProvider extends AbstractStreamProvider {
  ...
  public readonly _metamask: ReturnType<
    RabbyInpageProvider['_getExperimentalApi']
  >;
  ...
  constructor(
    ...
    {
      jsonRpcStreamName = RabbyInpageProviderStreamName,
      logger = console,
  ...
  protected _getExperimentalApi() {
    return new Proxy(
      {
        /**
         * Determines if Rabby is unlocked by the user.
         *
         * @returns Promise resolving to true if Rabby is currently unlocked.
         */
        isUnlocked: async () => {
