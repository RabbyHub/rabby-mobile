...
class MenuView(private val mContext: ReactContext) : ReactViewGroup(mContext) {
  ...
  fun show(actions: ReadableArray? = null){
    if (actions != null) {
      mActions = actions
    }
    prepareMenu()
